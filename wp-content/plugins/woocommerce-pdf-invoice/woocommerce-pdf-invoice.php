...
class WooPDF
{
    ...
    {
        // Load helper class
        require_once WOOPDF_PLUGIN_PATH . 'rightpress/rightpress-helper.class.php';
        require_once WOOPDF_PLUGIN_PATH . 'rightpress/rightpress-wc-meta.class.php';
        require_once WOOPDF_PLUGIN_PATH . 'rightpress/rightpress-wc-legacy.class.php';
    ...
    public function user_invoice_link($order)
    {
        ...
        // Show proforma link
            ...
            $order_key = RightPress_Helper::wc_version_gte('3.0') ? $order->get_order_key() : $order->order_key;
            $download_url = home_url('/?wpd_proforma=' . RightPress_WC_Legacy::order_get_id($order) . '&order_key=' . $order_key);
    ...
    public function push_proforma()
    {
        ...
        if (!$this->is_user_ok() && (get_current_user_id() != RightPress_WC_Legacy::order_get_customer_id($order) || !is_user_logged_in()) && (empty($_REQUEST['order_key']) || $_REQUEST['order_key'] !== $order_key)) {
            return;
        }
