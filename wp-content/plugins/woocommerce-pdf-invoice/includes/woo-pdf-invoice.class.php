...
class WooPdfInvoice extends TCPDF
{
    ...
    public function get_totals()
    {
        ...
        foreach ($this->order_tax as $tax_key => $tax) {
            $totals_taxes[$tax_key] = array(
                'name'  => RightPress_WC_Legacy::order_item_tax_get_label($tax),
    ...
    public function replace_macros($string, $remove_empty_lines = false)
    {
        ...
        $macros = array(
            ...
            '{{billing_first_name}}'    => RightPress_WC_Legacy::order_get_billing_first_name($this->orderData),
            '{{billing_last_name}}'     => RightPress_WC_Legacy::order_get_billing_last_name($this->orderData),
            '{{billing_company}}'       => addslashes(RightPress_WC_Legacy::order_get_billing_company($this->orderData)),
            '{{billing_address_1}}'     => addslashes(RightPress_WC_Legacy::order_get_billing_address_1($this->orderData)),
            '{{billing_address_2}}'     => addslashes(RightPress_WC_Legacy::order_get_billing_address_2($this->orderData)),
            ...
            '{{shipping_company}}'      => addslashes(RightPress_WC_Legacy::order_get_shipping_company($this->orderData)),
            '{{shipping_address_1}}'    => addslashes(RightPress_WC_Legacy::order_get_shipping_address_1($this->orderData)),
            '{{shipping_address_2}}'    => addslashes(RightPress_WC_Legacy::order_get_shipping_address_2($this->orderData)),
